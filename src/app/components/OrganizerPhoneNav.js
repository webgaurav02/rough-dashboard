...
const OrganizerPhoneNav = () => {
    ...
    return (
        <div className='bg-[#555555]  w-screen h-[7svh] rounded-t-lg px-16 flex flex-row items-center justify-between md:hidden fixed bottom-0 z-10'>
            ...
            <Link href='/durand-cup/dashboard/scan' className='bg-white text-black shadow-xl absolute right-[calc(50%-40px)] bottom-[10px] w-[80px] h-[80px] rounded-full flex justify-center items-center'>
